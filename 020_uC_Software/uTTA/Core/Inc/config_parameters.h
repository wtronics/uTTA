...
#define CHANNEL_NAME_MAX_LENGTH 31								// Max Length of the channel Name
#define MAX_DUT_NAME_LENGTH 50 + 5 		// Max length of the Dut name + 4 characters for file extension (.umf)
