...
import library.uTTA_data_processing as ud_deconv
import library.uTTA_data_import as ud_import


FileNam = ud_import.select_file('Open a t3i-File', (('T3I Measurement Files', '*.t3i'), ('All files', '*.*')))
DataFile, DataFileNoExt, FilePath = ud_import.split_file_path(FileNam)
